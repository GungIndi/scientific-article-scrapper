...
2. Check connection string in `scraper/config.py`
3. For Docker: ensure MongoDB container is running: `docker ps`

### Scraping Fails

**Problem**: Scraping returns no results or errors

**Solution**:
1. Check internet connection
2. Verify target websites are accessible
3. Check if website structure has changed (may need scraper updates)
...
2. Check CORS middleware configuration in `api/main.py`
3. Ensure frontend is making requests to correct URL
...
sudo lsof -i :8000  # or :27017 for MongoDB
...
- **Sinta** (Sistema Informasi Riset Teknologi Sains Pendidikan) - Journal metadata source
- **Garuda** (Garba Rujukan Digital) - Article database source
...
**Note**: This tool is designed for academic and research purposes. Please respect the terms of service of the data sources and use responsibly.
